...
Certified: 2026-09-01T22:06:55.505Z
Signature: 1389e23ffb3d9067a0fcdb9f313fa36b78bd53b099caaece75f3a5315cf02cb0
...
- **S1** (Union growth, ASR wiring, and the Qwen preset):
  - lib/config/token-plan-presets.ts::TokenPlanModality
  - lib/config/token-plan-presets.ts::MODALITY_ORDER
  - lib/config/token-plan-presets.ts::TOKEN_PLAN_PRESETS
  - lib/config/apply-token-plan.ts::applyModality
  - lib/config/apply-token-plan.ts::removeModality
  - lib/config/apply-token-plan.ts::TokenPlanActions
  - components/settings/token-plan-settings.tsx::MODALITY_LABEL_KEYS
  - components/settings/token-plan-settings.tsx::MODALITY_ICONS
- **S2** (Precedence and clobber pins):
  - tests/config/token-plan-precedence.test.ts::PRECEDENCE_SECTIONS
- **S3** (Env pointers and server-providers.yml.example):
  - tests/server/server-providers-example.test.ts::EXAMPLE_TOKEN_PLAN_IDS
- **S4** (Docs refresh):
  - README.md::Token Plan

### Gates Passed

- **S1**:
  - G1.1: {"id":"G1.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n \u001b[32m✓\u001b[39m tests/config/apply-token-plan.test.ts \u001b[2m(\u001b[22m\u001b[2m12 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 5\u001b[2mms\u001b[22m\u001b[39m\n\n\u001b[2m Test Files \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[1m\u001b[32m12 passed\u001b[39m\u001b[22m\u001b[90m (12)\u001b[39m\n\u001b[2m   Start at \u001b[22m 23:43:17\n\u001b[2m   Duration \u001b[22m 195ms\u001b[2m (transform 47ms, setup 9ms, import 127ms, tests 5ms, environment 0ms)\u001b[22m\n\n","passed":true}
  - G1.2: {"id":"G1.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"TSC_OK\n","passed":true}
  - G1.3: {"id":"G1.3","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n> openmaic@1.0.0 check:i18n-keys /Users/franky/Projects/MyOpenMAIC/Source/openMAIC\n> node scripts/check-i18n-keys.mjs\n\ni18n key alignment check passed (12 locale files, source: en-US.json).\n","passed":true}
- **S2**:
  - G2.1: {"id":"G2.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/config/token-plan-precedence.test.ts\u001b[2m > \u001b[22m\u001b[2mtoken-plan precedence\u001b[2m > \u001b[22m\u001b[2mserver values win when server env is present\u001b[2m > \u001b[22m\u001b[2mllm resolvers\u001b[2m > \u001b[22m\u001b[2mresolveApiKey returns server value over client store value\n\u001b[22m\u001b[39m[2026-09-01T11:31:58.437Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 7 LLM, 1 TTS, 1 ASR, 0 PDF, 2 Image, 1 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/config/token-plan-precedence.test.ts\u001b[2m > \u001b[22m\u001b[2mtoken-plan precedence\u001b[2m > \u001b[22m\u001b[2mserver values win when server env is present\u001b[2m > \u001b[22m\u001b[2mllm resolvers\u001b[2m > \u001b[22m\u001b[2mresolveBaseUrl returns server value over client store value\n\u001b[22m\u001b[39m[2026-09-01T11:31:58.439Z] [INFO] [ServerProviderConfig] [Serve","passed":true}
  - G2.2: {"id":"G2.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/server/provider-config.test.ts\u001b[2m > \u001b[22m\u001b[2mprovider-config\u001b[2m > \u001b[22m\u001b[2mresolveApiKey\u001b[2m > \u001b[22m\u001b[2mreturns server key from env when no client key\n\u001b[22m\u001b[39m[2026-09-01T11:31:59.160Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 1 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/server/provider-config.test.ts\u001b[2m > \u001b[22m\u001b[2mprovider-config\u001b[2m > \u001b[22m\u001b[2mresolveApiKey\u001b[2m > \u001b[22m\u001b[2mignores client key for a server-managed provider (server is authoritative)\n\u001b[22m\u001b[39m[2026-09-01T11:31:59.163Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 1 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/","passed":true}
  - G2.3: {"id":"G2.3","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n \u001b[32m✓\u001b[39m tests/config/token-plan-apply-persist.test.ts \u001b[2m(\u001b[22m\u001b[2m1 test\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 3\u001b[2mms\u001b[22m\u001b[39m\n\n\u001b[2m Test Files \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m   Start at \u001b[22m 23:31:59\n\u001b[2m   Duration \u001b[22m 476ms\u001b[2m (transform 281ms, setup 13ms, import 401ms, tests 3ms, environment 0ms)\u001b[22m\n\n\u001b[90mstderr\u001b[2m | tests/config/token-plan-apply-persist.test.ts\u001b[2m > \u001b[22m\u001b[2mtoken plan apply + probe model write\u001b[2m > \u001b[22m\u001b[2mkeeps apiKey/baseUrl/type after a models-only follow-up write\n\u001b[22m\u001b[39m[2026-09-01T11:32:00.105Z] [ERROR] [KVPersist] Refusing to persist \"settings-storage\" while its storage is unhydrated. Changes made in this session are not being saved.\n\n\u001b[90mstderr\u001b[2m | tests/c","passed":true}
- **S3**:
  - G3.1: {"id":"G3.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/server/server-providers-example.test.ts\u001b[2m > \u001b[22m\u001b[2mserver-providers.yml.example\u001b[2m > \u001b[22m\u001b[2mresolves all five token-plan ids through isServerConfiguredProvider\n\u001b[22m\u001b[39m[2026-09-01T11:32:04.931Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 7 LLM, 1 TTS, 1 ASR, 0 PDF, 2 Image, 1 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/server/server-providers-example.test.ts\u001b[2m > \u001b[22m\u001b[2mserver-providers.yml.example\u001b[2m > \u001b[22m\u001b[2mspot-checks one base_url per token-plan section\n\u001b[22m\u001b[39m[2026-09-01T11:32:04.933Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 7 LLM, 1 TTS, 1 ASR, 0 PDF, 2 Image, 1 Video, 0 WebSearch providers\n\n \u001b[32m✓\u001b[39m tests/server/server-providers-e","passed":true}
  - G3.2: {"id":"G3.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/server/provider-config.test.ts\u001b[2m > \u001b[22m\u001b[2mprovider-config\u001b[2m > \u001b[22m\u001b[2mresolveApiKey\u001b[2m > \u001b[22m\u001b[2mreturns server key from env when no client key\n\u001b[22m\u001b[39m[2026-09-01T11:32:05.515Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 1 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/server/provider-config.test.ts\u001b[2m > \u001b[22m\u001b[2mprovider-config\u001b[2m > \u001b[22m\u001b[2mresolveApiKey\u001b[2m > \u001b[22m\u001b[2mignores client key for a server-managed provider (server is authoritative)\n\u001b[22m\u001b[39m[2026-09-01T11:32:05.519Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 1 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/","passed":true}
- **S4**:
  - G4.1: {"id":"G4.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"       4\n","passed":true}
  - G4.2: {"id":"G4.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"84:| Qwen Token Plan ASR | `qwen-token-plan-asr` | Qwen Audio 3.0 ASR Flash (`qwen-audio-3.0-asr-flash`)                                                                                                                                                                                                                                                      |\n","passed":true}

Certification hash: 1389e23ffb3d9067a0fcdb9f313fa36b78bd53b099caaece75f3a5315cf02cb0
Certified: 2026-09-01T22:06:55.505Z | Signature: 1389e23ffb3d9067a0fcdb9f313fa36b78bd53b099caaece75f3a5315cf02cb0 | Certifier: verifier
