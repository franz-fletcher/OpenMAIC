...
Certified: 2026-08-31T09:09:49.923Z
Signature: 955fea985d6817a0b15fcfc564b1b4f17ff7da610cfeb3421616a90e9191f1cf
...
- **S1** (Registry and identity):
  - lib/audio/types.ts::BuiltInTTSProviderId
  - lib/audio/constants.ts::TTS_PROVIDERS
  - lib/audio/constants.ts::DEFAULT_TTS_VOICES
  - lib/audio/constants.ts::DEFAULT_TTS_MODELS
  - lib/audio/provider-display.ts::TTS_PROVIDER_NAME_KEYS
  - lib/audio/data/qwen-token-plan-base-voices.ts::qwenTokenPlanBaseVoices
- **S2** (WebSocket synthesis core and connection pool):
  - lib/audio/tts-providers.ts::generateTTS
  - lib/audio/qwen-token-plan-ws.ts::generateQwenTokenPlanTTS
  - lib/audio/qwen-token-plan-ws.ts::QwenTokenPlanWsPool
- **S3** (Server wiring and route):
  - lib/server/provider-config.ts::TTS_ENV_MAP
- **S4** (Live smoke and protocol pin):
  - tests/audio/qwen-token-plan-tts-live.test.ts::qwenTokenPlanTtsLiveSmoke
- **S5** (Classroom pipeline acceptance):
  - lib/hooks/use-scene-generator.ts::generateAndStoreTTS
  - lib/server/agent-runtime/scene-tts.ts::synthesizeSceneNarration

### Gates Passed

- **S1**:
  - G1.3: {"id":"G1.3","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"      12\n","passed":true}
  - G1.1: {"id":"G1.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"","passed":true}
...
- **S2**:
  - G2.1: {"id":"G2.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n \u001b[32m✓\u001b[39m tests/audio/qwen-token-plan-tts.test.ts \u001b[2m(\u001b[22m\u001b[2m14 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 161\u001b[2mms\u001b[22m\u001b[39m\n\n\u001b[2m Test Files \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[1m\u001b[32m14 passed\u001b[39m\u001b[22m\u001b[90m (14)\u001b[39m\n\u001b[2m   Start at \u001b[22m 20:17:27\n\u001b[2m   Duration \u001b[22m 321ms\u001b[2m (transform 80ms, setup 12ms, import 90ms, tests 161ms, environment 0ms)\u001b[22m\n\n","passed":true}
  - G2.2: {"id":"G2.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n \u001b[32m✓\u001b[39m tests/audio/qwen-token-plan-tts-protocol.test.ts \u001b[2m(\u001b[22m\u001b[2m8 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 56\u001b[2mms\u001b[22m\u001b[39m\n\n\u001b[2m Test Files \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[1m\u001b[32m8 passed\u001b[39m\u001b[22m\u001b[90m (8)\u001b[39m\n\u001b[2m   Start at \u001b[22m 20:17:27\n\u001b[2m   Duration \u001b[22m 208ms\u001b[2m (transform 78ms, setup 10ms, import 90ms, tests 56ms, environment 0ms)\u001b[22m\n\n","passed":true}
- **S3**:
  - G3.1: {"id":"G3.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/server/provider-config.test.ts\u001b[2m > \u001b[22m\u001b[2mprovider-config\u001b[2m > \u001b[22m\u001b[2mresolveApiKey\u001b[2m > \u001b[22m\u001b[2mreturns server key from env when no client key\n\u001b[22m\u001b[39m[2026-08-31T08:48:27.743Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 1 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/server/provider-config.test.ts\u001b[2m > \u001b[22m\u001b[2mprovider-config\u001b[2m > \u001b[22m\u001b[2mresolveApiKey\u001b[2m > \u001b[22m\u001b[2mignores client key for a server-managed provider (server is authoritative)\n\u001b[22m\u001b[39m[2026-08-31T08:48:27.747Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 1 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/","passed":true}
  - G3.2: {"id":"G3.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"","passed":true}
  - G3.3: {"id":"G3.3","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/server/tts-route-missing-key.test.ts\u001b[2m > \u001b[22m\u001b[2mPOST /api/generate/tts missing-key contract (#665)\u001b[2m > \u001b[22m\u001b[2mreturns 400 MISSING_API_KEY for 'openai-tts' with no key (server or client)\n\u001b[22m\u001b[39m[2026-08-31T08:48:32.422Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 0 Image, 0 Video, 0 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/server/tts-route-missing-key.test.ts\u001b[2m > \u001b[22m\u001b[2mPOST /api/generate/tts missing-key contract (#665)\u001b[2m > \u001b[22m\u001b[2mreturns 400 MISSING_API_KEY for 'qwen-token-plan-tts' with no key (server or client)\n\u001b[22m\u001b[39m[2026-08-31T08:48:32.425Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 0 ","passed":true}
- **S4**:
  - G4.1: {"id":"G4.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/audio/qwen-token-plan-tts-live.test.ts\u001b[2m > \u001b[22m\u001b[2mqwen-token-plan-tts live smoke\u001b[2m > \u001b[22m\u001b[2msynthesizes mp3 audio for the plus model with longanlingxin\n\u001b[22m\u001b[39m[qwen-token-plan-tts-live] ok model=qwen-audio-3.0-tts-plus voice=longanlingxin bytes=22242 format=mp3\n\n\u001b[90mstdout\u001b[2m | tests/audio/qwen-token-plan-tts-live.test.ts\u001b[2m > \u001b[22m\u001b[2mqwen-token-plan-tts live smoke\u001b[2m > \u001b[22m\u001b[2mrejects an unknown voice with a typed error and recovers on the same pool\n\u001b[22m\u001b[39m[qwen-token-plan-tts-live] ok model=qwen-audio-3.0-tts-plus voice=longanlingxin bytes=9704 format=mp3\n\n \u001b[32m✓\u001b[39m tests/audio/qwen-token-plan-tts-live.test.ts \u001b[2m(\u001b[22m\u001b[2m2 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[33m 5632\u001b[2mms\u001b[22m\u001b[39m\n     \u001b[33m\u001b[2m✓\u001b[22m\u001b[39m synthesizes mp3 audio for the ","passed":true}
  - G4.2: {"id":"G4.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n \u001b[32m✓\u001b[39m tests/audio/qwen-token-plan-tts-protocol.test.ts \u001b[2m(\u001b[22m\u001b[2m8 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 55\u001b[2mms\u001b[22m\u001b[39m\n\n\u001b[2m Test Files \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[1m\u001b[32m8 passed\u001b[39m\u001b[22m\u001b[90m (8)\u001b[39m\n\u001b[2m   Start at \u001b[22m 20:41:06\n\u001b[2m   Duration \u001b[22m 231ms\u001b[2m (transform 90ms, setup 13ms, import 102ms, tests 55ms, environment 0ms)\u001b[22m\n\n","passed":true}
  - G4.3: {"id":"G4.3","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/audio/qwen-token-plan-tts-live.test.ts\n\u001b[22m\u001b[39m[qwen-token-plan-tts-live] SKIPPED: TEST_LOAD_LOCAL_ENV is not \"1\"; .env.local is not loaded and live probes stay opt-in.\n\n \u001b[2m\u001b[90m↓\u001b[39m\u001b[22m tests/audio/qwen-token-plan-tts-live.test.ts \u001b[2m(\u001b[22m\u001b[2m1 test\u001b[22m\u001b[2m | \u001b[22m\u001b[33m1 skipped\u001b[39m\u001b[2m)\u001b[22m\n\n\u001b[2m Test Files \u001b[22m \u001b[33m1 skipped\u001b[39m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[33m1 skipped\u001b[39m\u001b[90m (1)\u001b[39m\n\u001b[2m   Start at \u001b[22m 20:41:07\n\u001b[2m   Duration \u001b[22m 200ms\u001b[2m (transform 90ms, setup 15ms, import 126ms, tests 0ms, environment 0ms)\u001b[22m\n\n","passed":true}
  - G4.4: {"id":"G4.4","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n \u001b[32m✓\u001b[39m tests/providers/provider-neutrality-guard.test.ts \u001b[2m(\u001b[22m\u001b[2m3 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 35\u001b[2mms\u001b[22m\u001b[39m\n\n\u001b[2m Test Files \u001b[22m \u001b[1m\u001b[32m1 passed\u001b[39m\u001b[22m\u001b[90m (1)\u001b[39m\n\u001b[2m      Tests \u001b[22m \u001b[1m\u001b[32m3 passed\u001b[39m\u001b[22m\u001b[90m (3)\u001b[39m\n\u001b[2m   Start at \u001b[22m 20:41:08\n\u001b[2m   Duration \u001b[22m 381ms\u001b[2m (transform 90ms, setup 15ms, import 270ms, tests 35ms, environment 0ms)\u001b[22m\n\n","passed":true}
- **S5**:
  - G5.1: {"id":"G5.1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/server/qwen-voice-route.test.ts\u001b[2m > \u001b[22m\u001b[2mQwen voice registration route\u001b[2m > \u001b[22m\u001b[2muses the shared default Qwen base URL when the request omits one\n\u001b[22m\u001b[39m[2026-08-31T08:48:44.798Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 1 LLM, 0 TTS, 0 ASR, 0 PDF, 0 Image, 0 Video, 0 WebSearch providers\n\n \u001b[32m✓\u001b[39m tests/server/qwen-voice-route.test.ts \u001b[2m(\u001b[22m\u001b[2m7 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 27\u001b[2mms\u001b[22m\u001b[39m\n\u001b[90mstdout\u001b[2m | tests/runtime/database-chat-cutover.test.ts\u001b[2m > \u001b[22m\u001b[2mdatabase runtime chat integration\u001b[2m > \u001b[22m\u001b[2mexports RuntimeStore chats and clears them with the main database\n\u001b[22m\u001b[39m[2026-08-31T08:48:45.390Z] [INFO] [Database] Database imported successfully\n\n\u001b[90mstdout\u001b[2m | tests/","passed":true}
  - G5.2: {"id":"G5.2","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n> openmaic@1.0.0 check /Users/franky/Projects/MyOpenMAIC/Source/openMAIC\n> prettier . --check\n\nChecking formatting...\nAll matched files use Prettier code style!\n","passed":true}

Certification hash: 955fea985d6817a0b15fcfc564b1b4f17ff7da610cfeb3421616a90e9191f1cf
Certified: 2026-08-31T09:09:49.923Z | Signature: 955fea985d6817a0b15fcfc564b1b4f17ff7da610cfeb3421616a90e9191f1cf | Certifier: verifier
