...
Certified: 2026-09-07T02:37:48.440Z
Signature: 21a2ef7b58ddaccddccd3c7383da90a721091d792d1286fe1a8f2a4d9497d513
...
- **S1** (Hermetic runner-skills registration):
  - tests/agent-runtime/runner-skills-registration.test.ts::runner-skills-registration.test.ts
  - docs/research/013-implementation-diagnosis.md::013-implementation-diagnosis.md
  - docs/specs/017-publishing-visibility.md::017-publishing-visibility.md
  - docs/specs/018-admin-suite.md::018-admin-suite.md
  - docs/specs/019-role-permission-editor.md::019-role-permission-editor.md
  - lib/server/agent-runtime/web-search.ts::resolveWebSearchCapability
  - tests/agent-runtime/runner-wakeup.test.ts::runner-wakeup.test.ts
- **S2** (i18n strays and repo hygiene):
  - lib/i18n/locales/en-US.json::en-US.json
  - lib/i18n/locales/ar-SA.json::ar-SA.json
  - lib/i18n/locales/de-DE.json::de-DE.json
  - lib/i18n/locales/es-MX.json::es-MX.json
  - lib/i18n/locales/fr-FR.json::fr-FR.json
  - lib/i18n/locales/ja-JP.json::ja-JP.json
  - lib/i18n/locales/ko-KR.json::ko-KR.json
  - lib/i18n/locales/pt-BR.json::pt-BR.json
  - lib/i18n/locales/ru-RU.json::ru-RU.json
  - lib/i18n/locales/vi-VN.json::vi-VN.json
  - lib/i18n/locales/zh-CN.json::zh-CN.json
  - lib/i18n/locales/zh-TW.json::zh-TW.json
  - components/admin/users-section.tsx::UsersSection
  - components/admin/roles-section.tsx::RolesSection
  - auth.config.mjs::auth.config.mjs
- **S3** (settingsGated gear visibility):
  - app/page.tsx::HomePage
  - tests/minimal-mode/minimal-layout.test.ts::minimal-layout.test.ts
  - components/header-capsule.tsx::HeaderCapsule
  - components/account-zone.tsx::account-zone.tsx
  - lib/hooks/use-permissions.ts::usePermissions

### Gates Passed

- **S1**:
  - g1: {"id":"g1","shell":"/bin/sh","cwd":"/Users/franky/Projects/MyOpenMAIC/Source/openMAIC","exit":0,"pathHash":"1bf61d2260bdd3fbe5be372aa11d01730dd2191c30d8d8a798ff0dfdfe6610e9","pathCount":30,"output":"\n> openmaic@1.0.0 test /Users/franky/Projects/MyOpenMAIC/Source/openMAIC\n> vitest run tests/agent-runtime/runner-skills-registration.test.ts tests/agent-runtime/runner-web-search-registration.test.ts tests/agent-runtime/runner-voice-registration.test.ts tests/agent-runtime/runner-wakeup.test.ts\n\n\n\u001b[1m\u001b[30m\u001b[46m RUN \u001b[49m\u001b[39m\u001b[22m \u001b[36mv4.1.8 \u001b[39m\u001b[90m/Users/franky/Projects/MyOpenMAIC/Source/openMAIC\u001b[39m\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-wakeup.test.ts\u001b[2m > \u001b[22m\u001b[2mrunSession NOTIFY wakeup wiring\u001b[2m > \u001b[22m\u001b[2msubscribes to the session route, wakes the cancel check and drain, and unsubscribes on settle\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.220Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 3 LLM, 1 TTS, 1 ASR, 1 PDF, 0 Image, 1 Video, 2 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-wakeup.test.ts\u001b[2m > \u001b[22m\u001b[2mrunSession NOTIFY wakeup wiring\u001b[2m > \u001b[22m\u001b[2msubscribes to the session route, wakes the cancel check and drain, and unsubscribes on settle\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.231Z] [INFO] [AgentRunner] session session-wake: steered 1 follow-up message(s)\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-web-search-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mweb_search runner registration\u001b[2m > \u001b[22m\u001b[2mregisters both tools and the web-search prompt block when a backend is configured\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.238Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 3 LLM, 1 TTS, 1 ASR, 1 PDF, 0 Image, 1 Video, 2 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-web-search-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mweb_search runner registration\u001b[2m > \u001b[22m\u001b[2mregisters both tools and the web-search prompt block when a backend is configured\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.239Z] [INFO] [AgentRunner] session session-1 -> succeeded (attempt 1, 0 tool calls)\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-web-search-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mweb_search runner registration\u001b[2m > \u001b[22m\u001b[2mregisters ask_user and the skill tools, but no web-search prompt, when nothing is configured\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.243Z] [INFO] [AgentRunner] session session-1 -> succeeded (attempt 1, 0 tool calls)\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-web-search-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mweb_search runner registration\u001b[2m > \u001b[22m\u001b[2mwires web_search result URLs to the session URL trust gate\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.243Z] [INFO] [AgentRunner] session session-1 -> succeeded (attempt 1, 0 tool calls)\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-web-search-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mweb_search runner registration\u001b[2m > \u001b[22m\u001b[2mlists the session materials in the system prompt so the model knows what it can read\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.244Z] [INFO] [AgentRunner] session session-1 -> succeeded (attempt 1, 0 tool calls)\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-web-search-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mweb_search runner registration\u001b[2m > \u001b[22m\u001b[2momits the materials block when the session has no materials\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.245Z] [INFO] [AgentRunner] session session-1 -> succeeded (attempt 1, 0 tool calls)\n\n \u001b[32m✓\u001b[39m tests/agent-runtime/runner-web-search-registration.test.ts \u001b[2m(\u001b[22m\u001b[2m5 tests\u001b[22m\u001b[2m)\u001b[22m\u001b[32m 12\u001b[2mms\u001b[22m\u001b[39m\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-skills-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mskills runner registration\u001b[2m > \u001b[22m\u001b[2mregisters the skill tools and the skill-scoped read tool, with a matching allowlist and prompt block\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.246Z] [INFO] [ServerProviderConfig] [ServerProviderConfig] Loaded (server-providers.yml): 3 LLM, 1 TTS, 1 ASR, 1 PDF, 0 Image, 1 Video, 2 WebSearch providers\n\n\u001b[90mstdout\u001b[2m | tests/agent-runtime/runner-skills-registration.test.ts\u001b[2m > \u001b[22m\u001b[2mskills runner registration\u001b[2m > \u001b[22m\u001b[2mregisters the skill tools and the skill-scoped read tool, with a matching allowlist and prompt block\n\u001b[22m\u001b[39m[2026-09-07T02:27:22.247Z] [INFO] [AgentRunner] session session-1 -> succeeded (attempt 1, 0 tool","passed":true}
