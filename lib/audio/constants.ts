...
export const ASR_PROVIDERS: Record<BuiltInASRProviderId, ASRProviderConfig> = {
  ...
  'qwen-token-plan-asr': {
    id: 'qwen-token-plan-asr',
    name: 'Qwen Token Plan ASR',
    requiresApiKey: true,
    defaultBaseUrl: 'https://token-plan.ap-southeast-1.maas.aliyuncs.com/api/v1',
    icon: '/logos/bailian.svg',
    models: [{ id: 'qwen-audio-3.0-asr-flash', name: 'qwen-audio-3.0-asr-flash' }],
    ...
    supportedFormats: ['wav', 'webm', 'mp3', 'opus'],
  },
